...
describe('ripple extraction', () => {
  it('handles "remember to" with "this Friday"', () => {
  ...
  it('handles "be sure to" and "this weekend"', () => {
  ...
  it('handles "gotta" and "by next week"', () => {
  ...
  it('keeps actionable ripples derived from shared verbs', () => {
